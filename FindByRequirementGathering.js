...
export default class FindByRequirementGathering extends Component {
    constructor(props){
        super(props)
        this.state={
            timeSheet:[],
        ...
        this.findByRequirementGather=this.findByRequirementGather.bind(this)
        this.HomePage=this.HomePage.bind(this)
    }
    findByRequirementGather(){
        TimeSheetService.findRequirementGathering()
        .then(
