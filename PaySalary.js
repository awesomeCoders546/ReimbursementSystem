  ...
  {/* ************************* input form */}
        ...
        <Dialog
            ...
            >
              ...
              <button className="btn btn-sm btn-primary" onClick={this.showMonthR}>Sunmit</button>
                  </div>
              </DialogContent>
        </Dialog> 
        <Dialog
            ...
            >
              ...
              <button className="btn btn-sm btn-primary" onClick={this.supervisorApr}>Sunmit</button>
                  </div>
              </DialogContent>
        </Dialog>
        <Dialog
          open={this.state.supervisorIdOpen2}
            ...
            >
              ...
              <button className="btn btn-sm btn-primary" onClick={this.supervisorDis}>Sunmit</button>
                  </div>
              </DialogContent>
        </Dialog>
