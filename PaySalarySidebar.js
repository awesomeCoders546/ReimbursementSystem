...
export default class PaySalarySidebar extends Component {
    constructor(props){
        super(props)
        this.state={
          accountReimburse: [],
        ...
        return (
          <Layout>
            <Sider trigger={null} collapsible  collapsed={this.state.collapsed} style={{backgroundColor:"black"}} width={270}>
              ...
              {!this.state.collapsed&&  <i className="fas fa-fw fa-tachometer-alt" style={{color:"#ffa426",marginLeft:'30px',alignItems:"center"}}/>}
          ...
          { !this.state.collapsed && <div class="sidebar-heading" style={{color:'#b7b9cc',textAlign: 'left',padding:' 0 1rem',
            ...
            <Content>
              <span className="Admin"style={{marginLeft:"40%",marginTop:"15%"}} >PaySalary</span>
              <PaySalarySidebarContent/>
