...
<div class="col-lg-12" style={{marginTop:'5%',marginBottom:'15%',marginLeft:'5%',width:'80vw'}}>
    ...
    <td> <div onClick={(e) => this.superApproved(e)} id="Rbutton" style={{ cursor: "pointer", textAlign: "center", padding: "9px", backgroundColor: "#22b1ed", border: "none", color: "white" }}>view</div></td>
    </tr>
    </tbody>
    <tbody>
    <tr>
    <td><p style={{ fontWeight: "800", padding: "9px" }}>Disapproved by supervisor</p></td>
    <td><div onClick={(e) => this.superDisapproved(e)} id="Rbutton" style={{ cursor: "pointer", textAlign: "center", padding: "9px", backgroundColor: "#22b1ed", border: "none", color: "white" }}>view</div></td>
    </tr>
    </tbody>
    <tbody>
    <tr>
    <td><p style={{ fontWeight: "800", padding: "9px" }}>Approved by accountant</p></td>
    <td><div onClick={(e) => this.accApproved(e)} id="Rbutton" style={{ cursor: "pointer", textAlign: "center", padding: "9px", backgroundColor: "#22b1ed", border: "none", color: "white" }}>view</div></td>
    </tr>
    </tbody>
    <tbody>
    <tr>
    <td><p style={{ fontWeight: "800",  padding: "9px" }}>Disapproved by accountant</p></td>
    <td><div onClick={(e) => this.accDisapproved(e)} id="Rbutton" style={{ cursor: "pointer", textAlign: "center", padding: "9px", backgroundColor: "#22b1ed", border: "none", color: "white" }}>view</div></td>
    </tr>
    </tbody>
    <tbody>
    <tr>
    <td><p style={{ fontWeight: "800", padding: "9px" }}>By month</p></td>
    <td><div onClick={(e) => this.openMonthsReim(e)} id="Rbutton" style={{ cursor: "pointer", textAlign: "center", padding: "9px", backgroundColor: "#22b1ed", border: "none", color: "white" }}>view</div></td>
    </tr>
    </tbody>             
    </table>			
      ...
      {/* ************************* input form */}
            ...
            <div className="card mt-5" id="view" style={{ display: "none", boxShadow: "0px 0px 10px 10px gray" ,left:'5%', marginRight:'10%',marginBottom:'20%' , backgroundColor: "white"}}>
             ...
             <div id="disview" className="card mt-5" style={{ display: "none", boxShadow: "0px 0px 10px 10px gray", left:'5%',marginRight:'10%',marginBottom:'20%' , backgroundColor: "white" }}>
      ...
      {/* *************************View Reimbursements approved by accountant */}
              ...
              <div className="card mt-5" id="accview" style={{ display: "none", boxShadow: "0px 0px 10px 10px gray" ,left:'5%', marginRight:'10%',marginBottom:'20%' , backgroundColor: "white"}}>
    ...
    {/* *************************View Reimbursements disapproved by accountant */}
             ...
             <div id="accdisview" className="card mt-5" style={{ display: "none", boxShadow: "0px 0px 10px 10px gray",left:'5%',marginRight:'10%', marginBottom:'20%' , backgroundColor: "white" }}>
     ...
     {/* *************************Reimbursements by months */}
        ...
        <div id="months" className="card mt-2" style={{ display: "none", boxShadow: "0px 0px 10px 10px gray",left:'5%', marginRight:'10%', marginBottom:'20%' ,backgroundColor: "white" }}>
    ...
    {/* *************************View Single Reimbursement */}
                ...
                >
                  ...
                  <div>
      <button onClick={this.printHandler} id="Rbutton" style={{ cursor: "pointer", textAlign: "center", borderRadius: "11%", padding: "9px", backgroundColor: "#ffbe2b", marginTop: "4px", border: "none", color: "black" }}>print PDF</button>
      </div>
            </Dialog>
            <Dialog
    ...
    export default PaySalarySidebarContent;