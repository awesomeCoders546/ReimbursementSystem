...
public interface ReimburseRepo extends JpaRepository<ReimbursementModel, Long>
{
	...
	@Query(value="SELECT * FROM reimbursement_table WHERE MONTH(date_of_reimburse) = ? AND YEAR(date_of_reimburse) = ?",nativeQuery=true)
	List<ReimbursementModel> findByMonth(String month, String year);
