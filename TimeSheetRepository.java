...
public interface TimeSheetRepository extends JpaRepository<TimeSheetModel, Integer> {
	...
	@Query(value="SELECT *FROM reimbursement.time_sheet WHERE YEARWEEK(date) = YEARWEEK(NOW()) and supervisor_approved='approved' and accountant_approved='waiting';" ,nativeQuery=true)
	List<TimeSheetModel> findByAccountantWeek();
	
	@Query(value="SELECT *FROM reimbursement.time_sheet WHERE YEARWEEK(date) = YEARWEEK(NOW()) and supervisor_approved='approved' and accountant_approved='waiting'and employee_id=?;" ,nativeQuery=true)
	List<TimeSheetModel> findByAccountantEmplopyeeWeek(long employeeId);
	
	@Query(value="SELECT * FROM  time_sheet WHERE YEARWEEK(date) = YEARWEEK(NOW()) and supervisor_approved='approved' and accountant_approved='approved' ;",nativeQuery=true)
	List<TimeSheetModel> findByAdminCWeek();
	
	@Query(value="SELECT * FROM  time_sheet WHERE date BETWEEN ? and ? and supervisor_approved='approved' and accountant_approved='approved';",nativeQuery=true)
	List<TimeSheetModel> findByAdminWeeklyT(String startDate,String endDate);
	
	@Query(value="SELECT * FROM  time_sheet WHERE date BETWEEN ? and ? and employee_id=? and supervisor_approved='approved' and accountant_approved='approved' ;",nativeQuery=true)
	List<TimeSheetModel> findByAdminWeeklyTimesheetE(String startDate,String endDate,long employeeId);
	@Query(value="SELECT * FROM  time_sheet WHERE date BETWEEN ? and ? and supervisor_approved='approved';",nativeQuery=true)
	List<TimeSheetModel> findByAccWeekly(String startDate,String endDate);
	
	@Query(value="SELECT * FROM  time_sheet WHERE date BETWEEN ? and ? and supervisor_approved='approved' and employee_id=? and accountant_approved='waiting';",nativeQuery=true)
	List<TimeSheetModel> findByAccWeeklyAndEmployee(String startDate,String endDate,long employeeId);
